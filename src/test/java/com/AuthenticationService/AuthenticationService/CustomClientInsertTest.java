...
import com.AuthenticationService.AuthenticationService.security.repositories.JpaRegisteredClientRepository;
...
@SpringBootTest
public class CustomClientInsertTest {
    @Autowired
...
//                .clientSecret(passwordEncoder.encode("productService-secret"))
